...
const updateCartSummary = (order) => {
    ...
    $("#cartsummary").append(`
        <div class="cartsummarybox1">
            ...
            <div class="cartbuttonalign"><button id="cartsubbutton" type="submit" ${disabled} class="cartbuttonstyle2">SUBMIT ORDER</button></div>
        </div>
        `);
        ...
        for (const i in order.orderLines) {
            ...
            $("#cartitems").append(`
                <div class="cartbuttonalign">
                    <button onclick="updateCart();" type="button" class="updatecartbutton"> UPDATE CART</button>
                </div>`);
    } else { // Shows nothing in cart
        $("#cartitems").append(`
            <div class="cartsummarybox1">
            <h2> YOUR ITEMS </h2>
            <div><h1>NOTHING TO SEE HERE...</h1> <p style="padding-bottom: 25%;"> There is nothing in your cart! Add something or update the cart to show items. </p> </div>
            <div class="cartbuttonalign">
                <button id="loadcartbutton" type="button" class="updatecartbutton"> LOAD CART</button>
            </div>
            </div>
        `);
    }
